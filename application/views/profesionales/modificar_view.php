...
<html lang="es">
    ...
    <body>
        <div class="contenedor">
            ...
            <?=form_open(base_url().'profesionales/mod/'.$idmod)?>
                <table id="t_datos">
                    <?php foreach ($mod as $fila){ ?>
                        <tr>
                        <?php $data = array('name'=>'matricula','id'=>'matricula','value'=>$fila->matricula,'maxlength'=>'20','size'=>'10');?>
                        ...
                        <tr>
                            ...
                            <td id="col2"><?=form_dropdown('especialidad', $especialidad, $fila->id_especialidad);?></td>
                        </tr>
                        <tr>
                        <?php $data = array('name'=>'telefono','id'=>'telefono','value'=>$fila->telefono,'maxlength'=>'30','size'=>'30');?>
                            ...
                            <td id="col2"><?=form_input($data)?></td>
                            <td id="col3"><?=form_error('telefono')?></td>
                        </tr>
                        <tr>
                        <?php $data = array('name'=>'email','id'=>'email','value'=>$fila->email,'maxlength'=>'30','size'=>'30');?>
                            <td id="col1"><label for="email">Email:</label></td>
                            <td id="col2"><?=form_input($data)?></td>
                            <td id="col3"><?=form_error('email')?></td>
                        </tr>
                    <?php } ?>
                    <tr>
                        <td colspan="2"><?=form_submit('submit','Modificar')?><a href="<?=base_url().'profesionales'?>">Volver</a></td>
                    </tr>
                </table>
            <?=form_close()?>
        </div>
